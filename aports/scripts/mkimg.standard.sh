profile_standard() {
	...
	apks="$apks bridge-utils openntpd doas build-base qemu qemu-img qemu-system-x86_64 docker docker-cli py3-pip git neovim neofetch python3 nim gcc iw wpa_supplicant"
        apkovl="aports/scripts/genapkovl-spark.sh"
}
